...
def run_test_make_simple_list():
    ...
    actual = make_simple_list(11, 15)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # Test 3:
    expected = [87, 88, 89, 90, 91, 92, 93]
    actual = make_simple_list(87, 93)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    # Test 2:
    expected = '3-4'
    actual = make_less_simple_string(3, 4)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def make_less_simple_string(m, n):
    ...
    less_simple_string = less_simple_string + str(n)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        ...
        r = circles[k].radius
        rect = rg.Rectangle(rg.Point(center.x + r, center.y - r), rg.Point(center.x - r, center.y + r))
