...
def run_test_draw_points_on_circle():
    ...
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 65)
...
def run_test_pizza():
    ...
    # Test 4:
    title = 'PIZZA test 4:  8 slices, thin (thickness=1) orange lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.outline_thickness = 3
    pizza(window, circle, 8, 'orange', 1)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    circle = rg.Circle(rg.Point(200, 300), 100)
    circle.outline_thickness = 3
...
def polygon(window, circle, number_of_segments, color, thickness):
    ...
    for k in range(number_of_segments-1):
        ...
        line.thickness = thickness
        line.attach_to(window)
    final_line = rg.Line(points[number_of_segments-1], points[0])
...
def run_test_fancy_polygon():
    ...
    # Test 4:
    title = 'FANCY POLYGON test 4:  9 black lines on purple circle, hops = 3.'
    window = rg.RoseWindow(480, 350, title)

    circle = rg.Circle(rg.Point(220, 160), 150)
    circle.fill_color = 'purple'
    fancy_polygon(window, circle, 9, 3, 'black', 5)
    window.close_on_mouse_click()
